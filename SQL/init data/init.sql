...
INSERT [dbo].[t_structure] ([IDENTIFICATION], [APPELLATION], [STRUCTUREXML]) VALUES (N'07880c98-caf1-494c-9c32-b52e686f3084', N'简单流程', N'<workflow><start id="30" name="开始" layout="260 23 70 -18" category="start"><transition name="提交部门助理审批" destination="32" layout="290,100 291,143"></transition></start><end id="31" name="结束" layout="266 23 346 -12" category="end"></end><node id="32" name="部门助理" layout="201 71 143 17" category="node"><transition name="提交部门经理审批" destination="33" layout="291,183 293,226"></transition><actor id="1" name="chengderen"/><actor id="2" name="xuq"/><actor id="4" name="zhangsan"/></node><node id="33" name="部门经理" layout="203 107 226 24" category="node"><group id="3" name="总经理"/><transition name="结束" destination="31" layout="293,266 296,316"></transition></node></workflow>')
