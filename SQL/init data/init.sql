...
INSERT [dbo].[t_structure] ([IDENTIFICATION], [APPELLATION], [STRUCTUREXML]) VALUES (N'07880c98-caf1-494c-9c32-b52e686f3084', N'简单流程', N'<workflow><start id="30" name="开始" layout="260 23 70 -18" category="start"><transition name="提交部门助理审批" destination="32" layout="290,100 288,143"></transition></start><end id="31" name="结束" layout="258 25 347 -15" category="end"></end><node id="32" name="部门助理" layout="198 99 143 8" category="node"><transition name="提交部门经理审批" destination="33" layout="288,183 291,230"></transition><actor id="2" name="xuq"/><actor id="1" name="chengderen"/><actor id="4" name="zhangsan"/></node><node id="33" name="部门经理" layout="201 89 230 -4" category="node"><transition name="结束" destination="31" layout="291,270 288,317"></transition><actor id="" name=""/><actor id="" name=""/></node></workflow>')
